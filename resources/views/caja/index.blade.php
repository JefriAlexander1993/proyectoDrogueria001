...
<table class="table table-hover">
    ...
    <tbody>
       ...
       <td><a title="Cerrar caja." id="edit" href="{{route('caja.edit', $caja->id)}}" class="btn btn-sm btn-default"><i class="fa fa-times-circle-o" aria-hidden="true"></i></a></td>
	   <td><a title="Ver caja." href="{{route('caja.show', $caja->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
