...
<table class="table table-hover ">
	...
	<tbody>
	   ...
	   <td class="text-center">{{$compra->fechaLlegada}}</td>
       <td class="text-center">{{$compra->nombre}}</td>
       <td class="text-center">{{$compra->rubio}}</td>
       ...
       <td class="text-center">{{$compra->precioVenta}}</td>
       <td class="text-center">{{$compra->fechaVencimiento}}</td>
	   <td class="text-center">{{$compra->stock}}</td>
